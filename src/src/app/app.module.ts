...
export function StartupServiceFactory(startupService: StartupService): () => Observable<void> {
  return () => startupService.loadLang();
}
...
import { Util, AppConfig } from '@dcsoft/util';
import { appConfig } from './app-config';
const CONFIG_PROVIDES = [{ provide: AppConfig, useValue: appConfig }];
...
@NgModule({
  ...
  providers: [...LANG_PROVIDES, ...INTERCEPTOR_PROVIDES, ...I18NSERVICE_PROVIDES, ...APPINIT_PROVIDES, ...CONFIG_PROVIDES],
